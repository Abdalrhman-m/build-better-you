  ...
  const handleToggleComplete = async () => {
    ...
    try {
      if (isCompletedForDate) {
        await onUncomplete(habit.id, selectedDate || undefined);
      } else {
        await onComplete(habit.id, selectedDate || undefined);
      }
    } finally {
          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="sm" className="h-8 w-8 p-0 text-gray-400 hover:text-gray-600 hover:bg-gray-100/60">
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete "{habit.name}"? This action cannot be undone and will remove all completion history for this habit.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
